...
export class ReferenceToolView extends SelectToolView {
  model: ReferenceTool
...
export namespace ReferenceTool {
...
export interface ReferenceTool extends ReferenceTool.Attrs {}

export class ReferenceTool extends SelectTool {

  constructor(attrs?: Partial<ReferenceTool.Attrs>, opts?: ReferenceTool.Opts) {
    super(attrs, opts)
  }

  static initClass() {
    this.prototype.type = "ReferenceTool"
    this.prototype.default_view = ReferenceToolView
