...
export class FixedWheelZoomToolView extends GestureToolView {
...
export class FixedWheelZoomTool extends GestureTool {

  static initClass() {
    this.prototype.type = "FixedWheelZoomTool"

    this.prototype.default_view = FixedWheelZoomToolView
