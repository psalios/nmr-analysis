...
export class IntegrationSelectToolView extends SelectToolView {

  model: IntegrationSelectTool
...
export class IntegrationSelectTool extends SelectTool {

  static initClass() {
    this.prototype.type = "IntegrationSelectTool"

    this.prototype.default_view = IntegrationSelectToolView
...
IntegrationSelectTool.initClass()
