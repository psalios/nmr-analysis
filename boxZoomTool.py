...
from bokeh.core.properties import Instance, List, Enum, Bool
...
class HorizontalBoxZoomToolView extends GestureTool.View
...
class HorizontalBoxZoomTool extends GestureTool.Model
  default_view: HorizontalBoxZoomToolView
  type: "BoxZoomTool"
  tool_name: "Box Zoom"
...
module.exports =
  Model: HorizontalBoxZoomTool
  View: HorizontalBoxZoomToolView
"""

class HorizontalBoxZoomTool(Drag):
   __implementation__ = BOXZOOMTOOLJS
