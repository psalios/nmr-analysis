...
export class HorizontalBoxZoomToolView extends GestureToolView {
...
export class HorizontalBoxZoomTool extends GestureTool {

  static initClass() {
    this.prototype.type = "HorizontalBoxZoomTool"

    this.prototype.default_view = HorizontalBoxZoomToolView
...
HorizontalBoxZoomTool.initClass()
