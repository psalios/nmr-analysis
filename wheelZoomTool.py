...
class FixedWheelZoomToolView extends GestureTool.View
  ...
  _scroll: (e) ->
    ...
    vy = @plot_view.frame.get('y_mappers').default.map_to_target(0) #@plot_view.canvas.sy_to_vy(e.bokeh.sy)
...
class FixedWheelZoomTool extends GestureTool.Model
  default_view: FixedWheelZoomToolView
  type: "FixedWheelZoomTool"
...
module.exports =
  Model: FixedWheelZoomTool
  View: FixedWheelZoomToolView
"""

class FixedWheelZoomTool(Scroll):
    __implementation__ = WHEELZOOMTOOLJS
